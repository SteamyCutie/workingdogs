...
const Footer = () => {
  ...
  return (
    <div className="flex justify-between px-16 py-1 mt-[250px] bg-[#0B0B0B]/30 backdrop-blur-[4px] h-[92px] border-t-[1px] border-t-[#353535]">
      ...
      <div className="menu-logo ml-[80px] text-[20px] flex items-center align-middle font-['Trouble_Font'] font-[400] tracking-[2px] leading-[24px]"><a href="/">WorkingDogs</a></div>
